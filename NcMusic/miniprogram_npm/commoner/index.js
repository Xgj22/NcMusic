...
__DEFINE__(1679192552428, function(require, module, exports) {
...
}, function(modId) {var map = {"./lib/commoner":1679192552429}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552429, function(require, module, exports) {
...
}, function(modId) { var map = {"./cache":1679192552430,"./watcher":1679192552432,"./context":1679192552434,"./reader":1679192552438,"./output":1679192552442,"../package.json":1679192552445}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552430, function(require, module, exports) {
var assert = require("assert");
var Q = require("q");
var fs = require("fs");
var path = require("path");
...
__DEFINE__(1679192552432, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
...
}, function(modId) { var map = {"./cache":1679192552430}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552434, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
var Q = require("q");
var util = require("./util");
...
}, function(modId) { var map = {"./cache":1679192552430,"./grep":1679192552436}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552436, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
var Q = require("q");
var fs = require("graceful-fs");
...
__DEFINE__(1679192552438, function(require, module, exports) {
var assert = require("assert");
var path = require("path");
var fs = require("fs");
var Q = require("q");
...
}, function(modId) { var map = {"./context":1679192552434,"./relative":1679192552440}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552440, function(require, module, exports) {
var assert = require("assert");
var Q = require("q");
var path = require("path");
var util = require("./util");
...
}, function(modId) { var map = {"./reader":1679192552438}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552442, function(require, module, exports) {
var assert = require("assert");
var util = require("./util");
var log = util.log;
...
__DEFINE__(1679192552445, function(require, module, exports) {
module.exports = {
  "author": {
    "name": "Ben Newman",
...
return __REQUIRE__(1679192552428);
})()
