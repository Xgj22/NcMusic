...
__DEFINE__(1679192552517, function(require, module, exports) {
...
}, function(modId) {var map = {"./lib/types":1679192552518,"./lib/parser":1679192552519,"./lib/printer":1679192552527}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552518, function(require, module, exports) {
...
__DEFINE__(1679192552519, function(require, module, exports) {
...
}, function(modId) { var map = {"./types":1679192552518,"./patcher":1679192552520,"./options":1679192552522,"./lines":1679192552521,"./comments":1679192552526,"./util":1679192552523}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552520, function(require, module, exports) {
var assert = require("assert");
...
}, function(modId) { var map = {"./lines":1679192552521,"./types":1679192552518,"./util":1679192552523,"./fast-path":1679192552525}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552521, function(require, module, exports) {
var assert = require("assert");
...
}, function(modId) { var map = {"./options":1679192552522,"./types":1679192552518,"./util":1679192552523,"./mapping":1679192552524}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552522, function(require, module, exports) {
var defaults = {
...
__DEFINE__(1679192552523, function(require, module, exports) {
var assert = require("assert");
var types = require("./types");
var getFieldValue = types.getFieldValue;
var n = types.namedTypes;
...
}, function(modId) { var map = {"./types":1679192552518}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552524, function(require, module, exports) {
var assert = require("assert");
var types = require("./types");
var isString = types.builtInTypes.string;
...
}, function(modId) { var map = {"./types":1679192552518,"./lines":1679192552521,"./util":1679192552523}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679192552525, function(require, module, exports) {
var assert = require("assert");
var types = require("./types");
var n = types.namedTypes;
var Node = n.Node;
...
__DEFINE__(1679192552526, function(require, module, exports) {
var assert = require("assert");
var types = require("./types");
var n = types.namedTypes;
var isArray = types.builtInTypes.array;
...
__DEFINE__(1679192552527, function(require, module, exports) {
var assert = require("assert");
var sourceMap = require("source-map");
...
}, function(modId) { var map = {"./comments":1679192552526,"./lines":1679192552521,"./options":1679192552522,"./patcher":1679192552520,"./types":1679192552518,"./fast-path":1679192552525,"./util":1679192552523}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1679192552517);
})()
